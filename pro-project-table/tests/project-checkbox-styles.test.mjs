...
const styles = readFileSync(
  new URL('../src/project-tracker-styles/_grid.scss', import.meta.url),
  'utf8',
);
const darkStyles = readFileSync(
  new URL('../src/project-tracker-styles/_dark.scss', import.meta.url),
  'utf8',
);
const headerFilterStyles = readFileSync(
  new URL('../src/project-tracker-styles/_header-filters.scss', import.meta.url),
  'utf8',
);
...
test('semantic block columns fill the complete grid cell', () => {
  const renderers = readFileSync(
    new URL('../src/project-tracker/renderers.ts', import.meta.url),
    'utf8',
  );
  const tokens = readFileSync(
    new URL('../src/project-tracker-styles/_tokens.scss', import.meta.url),
    'utf8',
  );
...
test('project tags and synced owner options keep one aligned visual surface', () => {
  const columns = readFileSync(
    new URL('../src/project-tracker/columns.ts', import.meta.url),
    'utf8',
  );
  const dropdownStyles = readFileSync(
    new URL('../src/project-tracker-styles/_dropdowns.scss', import.meta.url),
    'utf8',
  );
...
test('project rows expose the shared Pro row-order configuration', () => {
  ...
  const plugins = readFileSync(
    new URL('../src/project-tracker/plugins.ts', import.meta.url),
    'utf8',
  );
...
test('the project Sort menu exposes additive multi-column sorting', () => {
  const actions = readFileSync(
    new URL('../src/project-tracker/actions.ts', import.meta.url),
    'utf8',
  );
  const toolbar = readFileSync(
    new URL('../src/project-tracker/toolbar.ts', import.meta.url),
    'utf8',
  );
