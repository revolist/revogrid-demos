...
const home = page({
  title: 'RevoGrid Examples · Nine production-style showcases',
  description: 'Explore RevoGrid Core, Pro, Pivot, Gantt, Kanban, Scheduler, and planning examples in TypeScript, React, Vue, and Angular.',
  content: `<section class="hero shell">
    <span class="eyebrow">RevoGrid in production</span>
    <h1>Nine complete ways to build beyond the data grid.</h1>
    <p>Run polished, framework-ready examples for analytics, planning, scheduling, workflow, spreadsheets, and high-performance data experiences.</p>
