...
const home = page({
  ...
  description: 'Explore RevoGrid Core, Pro filtering, infinity scroll, column collapse, universal context menus, master detail, audit history, and tree data, plus Pivot, Gantt, Kanban, Scheduler, and planning examples in TypeScript, React, Vue, and Angular.',
  content: `<section class="hero shell">
    ...
    <p>Run polished, framework-ready examples for filtering, remote loading, grouped columns, universal context menus, master detail, audit history, hierarchy, analytics, planning, scheduling, workflow, spreadsheets, and high-performance data experiences.</p>
